window.addEventListener('load', () => {
	...
	const searchClickFn = () => {
		...
		document.querySelector('#algolia-search .search-close-button').addEventListener('click',
			closeSearch)
	}
			...
			templates: {
				...
				empty: function(data) {
					return (
						...
						GLOBAL_CONFIG.algolia.languages.hits_empty.replace(/\$\{query}/,
							data.query) +
						'</div>'
					)
				}
